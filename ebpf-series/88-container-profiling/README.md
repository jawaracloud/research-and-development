# 88 — Container Resource Usage Profiling

> **Type:** How-To

## What you're building

Per-cgroup CPU, memory, and I/O counters from eBPF maps.
...
// TODO: implement the 88-container-profiling eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 88-container-profiling.bpf.c
...
go build -o 88-container-profiling .
sudo ./88-container-profiling
```
...
| Concept | Description |
|---------|-------------|
| Hook | `cgroup + perf_event` — the kernel attach point |
