# 63 — Tracing Service (ClusterIP) Traffic

> **Type:** How-To

## What you're building

Trace connections to ClusterIP addresses. Resolve Service name from IP.
...
// TODO: implement the 63-service-traffic eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 63-service-traffic.bpf.c
...
go build -o 63-service-traffic .
sudo ./63-service-traffic
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/tcp_connect` — the kernel attach point |
