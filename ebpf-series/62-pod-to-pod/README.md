# 62 — Tracing Pod-to-Pod Communication

> **Type:** How-To

## What you're building

Identify pod → pod flows by resolving veth index → pod name via /proc and k8s API.
...
// TODO: implement the 62-pod-to-pod eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 62-pod-to-pod.bpf.c
