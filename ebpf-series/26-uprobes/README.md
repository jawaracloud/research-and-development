# 26 — Uprobes: Tracing Userspace Functions

> **Type:** How-To

## What you're building

Attach to a symbol in a shared library or binary. link.UprobeEx with offset calculation.
...
// TODO: implement the 26-uprobes eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 26-uprobes.bpf.c
