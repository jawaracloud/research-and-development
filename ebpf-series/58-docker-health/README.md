# 58 — Docker Health Check Integration

> **Type:** How-To

## What you're building

Correlate Docker health check failures with eBPF-observed errors in the container.
...
// TODO: implement the 58-docker-health eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 58-docker-health.bpf.c
...
go build -o 58-docker-health .
sudo ./58-docker-health
```
...
| Concept | Description |
|---------|-------------|
| Hook | `uprobe` — the kernel attach point |
