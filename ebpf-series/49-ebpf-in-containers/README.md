# 49 — eBPF Inside Containers: Capabilities Required

> **Type:** Explanation

## What you're building

Which capabilities are needed, BPF namespace (kernel 5.14+), user namespaces limitations.
...
// TODO: implement the 49-ebpf-in-containers eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 49-ebpf-in-containers.bpf.c
...
go build -o 49-ebpf-in-containers .
sudo ./49-ebpf-in-containers
```
