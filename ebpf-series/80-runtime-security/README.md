# 80 — Building a Runtime Security Agent

> **Type:** Tutorial

## What you're building

Combine exec, file, and network eBPF probes into a unified security event stream.
...
// TODO: implement the 80-runtime-security eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 80-runtime-security.bpf.c
...
go build -o 80-runtime-security .
sudo ./80-runtime-security
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe + lsm + cgroup` — the kernel attach point |
