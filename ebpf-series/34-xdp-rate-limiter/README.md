...
Token-bucket rate limiter per source IP using a BPF_MAP_TYPE_HASH in XDP.
...
// TODO: implement the 34-xdp-rate-limiter eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 34-xdp-rate-limiter.bpf.c
...
go build -o 34-xdp-rate-limiter .
sudo ./34-xdp-rate-limiter
```
