# 46 — Tracing Container Lifecycle Events

> **Type:** How-To

## What you're building

Detect container start/stop by watching runc/containerd fork+exec patterns.
...
| eBPF hook | `tracepoint/sched/sched_process_exec` |
...
// TODO: implement the 46-container-lifecycle eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 46-container-lifecycle.bpf.c
...
go build -o 46-container-lifecycle .
sudo ./46-container-lifecycle
```
...
| Concept | Description |
|---------|-------------|
| Hook | `tracepoint/sched/sched_process_exec` — the kernel attach point |
