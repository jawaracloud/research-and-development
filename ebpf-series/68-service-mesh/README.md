# 68 — eBPF-Based Service Mesh Concepts

> **Type:** Explanation

## What you're building

How Cilium Mutual Auth, L7 policy, and encryption work via eBPF sock programs.
...
// TODO: implement the 68-service-mesh eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 68-service-mesh.bpf.c
...
go build -o 68-service-mesh .
sudo ./68-service-mesh
```
...
| Concept | Description |
|---------|-------------|
| Hook | `cgroup/connect4` — the kernel attach point |
