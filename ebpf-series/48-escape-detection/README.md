# 48 — Detecting Privileged Container Escapes

> **Type:** How-To

## What you're building

Monitor setns() calls to detect container escaping to host namespace.
...
// TODO: implement the 48-escape-detection eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 48-escape-detection.bpf.c
...
go build -o 48-escape-detection .
sudo ./48-escape-detection
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/setns` — the kernel attach point |
