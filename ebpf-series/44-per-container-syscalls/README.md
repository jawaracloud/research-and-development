# 44 — Per-Container Syscall Counting

> **Type:** Tutorial

## What you're building

Per-cgroup syscall frequency map. Detect anomalous syscall bursts per container.
...
| eBPF hook | `raw_tracepoint/sys_enter` |
...
// TODO: implement the 44-per-container-syscalls eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 44-per-container-syscalls.bpf.c
...
go build -o 44-per-container-syscalls .
sudo ./44-per-container-syscalls
```
...
| Concept | Description |
|---------|-------------|
| Hook | `raw_tracepoint/sys_enter` — the kernel attach point |
