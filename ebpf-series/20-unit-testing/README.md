# 20 — Unit Testing eBPF Go Code

> **Type:** How-To + Tutorial

## What you're building

cilium/ebpf test helpers, BPF_TEST_RUN, table-driven tests for map logic.
...
// TODO: implement the 20-unit-testing eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 20-unit-testing.bpf.c
...
go build -o 20-unit-testing .
sudo ./20-unit-testing
```
