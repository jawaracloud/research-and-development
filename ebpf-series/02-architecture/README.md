# 02 — eBPF Architecture: Verifier, JIT, Maps, Hooks

> **Type:** Explanation

## What you're building

Explore the full eBPF execution pipeline: bytecode → verifier → JIT → map I/O → event.
...
// TODO: implement the 02-architecture eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 02-architecture.bpf.c
...
go build -o 02-architecture .
sudo ./02-architecture
```
