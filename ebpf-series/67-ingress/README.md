# 67 — Ingress Traffic Analysis

> **Type:** How-To

## What you're building

Observe ingress-controller traffic: client IP, host header, response code at XDP layer.
...
// TODO: implement the 67-ingress eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 67-ingress.bpf.c
