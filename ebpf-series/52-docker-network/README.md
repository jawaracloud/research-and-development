# 52 — Monitoring Docker Network (veth, bridges)

> **Type:** How-To

## What you're building

Attach TC programs to veth interfaces. Map interface index → container name.
...
// TODO: implement the 52-docker-network eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 52-docker-network.bpf.c
...
go build -o 52-docker-network .
sudo ./52-docker-network
```
