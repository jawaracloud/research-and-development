# 73 — Restricting Network Connections with LSM-BPF

> **Type:** How-To

## What you're building

Deny connections to non-whitelisted IPs using LSM socket_connect hook.
...
// TODO: implement the 73-lsm-network eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 73-lsm-network.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `lsm/socket_connect` — the kernel attach point |
