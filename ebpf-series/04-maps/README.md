# 04 — eBPF Maps: Hash, Array, Ring Buffer, Per-CPU

> **Type:** Explanation + Reference

## What you're building

Deep dive into eBPF maps — the shared memory between kernel programs and userspace.
...
// TODO: implement the 04-maps eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 04-maps.bpf.c
