# 69 — Kubernetes CNI and eBPF Integration

> **Type:** Explanation

## What you're building

CNI plugin lifecycle, how Cilium replaces kube-proxy with eBPF TC programs.
...
// TODO: implement the 69-cni eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 69-cni.bpf.c
