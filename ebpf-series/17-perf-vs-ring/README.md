# 17 — Perf Buffer vs Ring Buffer

> **Type:** Explanation

## What you're building

When to use BPF_MAP_TYPE_PERF_EVENT_ARRAY vs BPF_MAP_TYPE_RINGBUF.
...
// TODO: implement the 17-perf-vs-ring eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 17-perf-vs-ring.bpf.c
...
go build -o 17-perf-vs-ring .
sudo ./17-perf-vs-ring
```
...
| Concept | Description |
|---------|-------------|
| Hook | `perf_event / ring_buf` — the kernel attach point |
