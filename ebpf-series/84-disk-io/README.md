# 84 — Disk I/O Latency Histograms

> **Type:** How-To

## What you're building

Block I/O start/complete time delta. Populate a BPF histogram map.
...
| eBPF hook | `kprobe/blk_mq_start_request` |
...
// TODO: implement the 84-disk-io eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 84-disk-io.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/blk_mq_start_request` — the kernel attach point |
