# 36 — TC (Traffic Control) eBPF Programs

> **Type:** How-To

## What you're building

Attach to ingress/egress qdisc with tc, modify packets, redirect flows.
...
// TODO: implement the 36-tc eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 36-tc.bpf.c
