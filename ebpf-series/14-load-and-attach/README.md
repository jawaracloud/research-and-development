# 14 — Loading and Attaching from Go

> **Type:** How-To

## What you're building

LoadBpfObjects, link.Kprobe, deferred Close — the standard cilium/ebpf lifecycle.
...
// TODO: implement the 14-load-and-attach eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 14-load-and-attach.bpf.c
...
go build -o 14-load-and-attach .
sudo ./14-load-and-attach
```
