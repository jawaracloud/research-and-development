# 89 — Flame Graphs from eBPF Data

> **Type:** How-To + Tutorial

## What you're building

Export BPF stack trace map → Brendan Gregg flamegraph.pl → SVG flame graph.
...
// TODO: implement the 89-flame-graphs eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 89-flame-graphs.bpf.c
...
go build -o 89-flame-graphs .
sudo ./89-flame-graphs
```
