# 45 — Per-Container Network Traffic Monitoring

> **Type:** Tutorial

## What you're building

Per-cgroup byte/packet counters in TC. Aggregate in Go and print per-container bandwidth.
...
// TODO: implement the 45-per-container-network eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 45-per-container-network.bpf.c
...
go build -o 45-per-container-network .
sudo ./45-per-container-network
```
