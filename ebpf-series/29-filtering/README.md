# 29 — Filtering Events by PID, UID, Cgroup

> **Type:** How-To

## What you're building

bpf_get_current_pid_tgid, bpf_get_current_cgroup_id — filter inside the kernel, not userspace.
...
// TODO: implement the 29-filtering eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 29-filtering.bpf.c
