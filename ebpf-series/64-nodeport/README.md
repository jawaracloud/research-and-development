# 64 — NodePort and LoadBalancer Tracing

> **Type:** How-To

## What you're building

Watch NodePort DNAT translations with XDP. Log original and NATed destination.
...
// TODO: implement the 64-nodeport eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 64-nodeport.bpf.c
