# 41 — Linux Namespaces and Cgroups Primer

> **Type:** Explanation

## What you're building

How Docker/K8s use pid, net, mnt, uts namespaces and cgroup v2 hierarchies.
...
// TODO: implement the 41-namespaces-cgroups eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 41-namespaces-cgroups.bpf.c
...
go build -o 41-namespaces-cgroups .
sudo ./41-namespaces-cgroups
```
