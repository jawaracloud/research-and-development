# 31 — XDP Overview: eXpress Data Path

> **Type:** Explanation

## What you're building

Where XDP sits in the kernel, driver vs generic vs offloaded modes, action codes.
...
// TODO: implement the 31-xdp-overview eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 31-xdp-overview.bpf.c
...
go build -o 31-xdp-overview .
sudo ./31-xdp-overview
```
