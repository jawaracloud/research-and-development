# 75 — Process Execution Monitoring (Falco-style)

> **Type:** How-To

## What you're building

Log every exec with cwd, argv, env subset, cgroup ID — Falco-compatible events.
...
| eBPF hook | `tracepoint/syscalls/sys_enter_execve` |
...
// TODO: implement the 75-exec-monitoring eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 75-exec-monitoring.bpf.c
...
go build -o 75-exec-monitoring .
sudo ./75-exec-monitoring
```
...
| Concept | Description |
|---------|-------------|
| Hook | `tracepoint/syscalls/sys_enter_execve` — the kernel attach point |
