# 42 — Identifying Containers via Cgroup ID

> **Type:** How-To

## What you're building

bpf_get_current_cgroup_id() returns the cgroup v2 ID. Map it to Docker container name.
...
// TODO: implement the 42-cgroup-id eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 42-cgroup-id.bpf.c
