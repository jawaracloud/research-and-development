# 54 — Docker DNS Resolution Tracing

> **Type:** How-To

## What you're building

Trace DNS queries from containers. Parse UDP payload for question section.
...
// TODO: implement the 54-docker-dns eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 54-docker-dns.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/udp_sendmsg` — the kernel attach point |
