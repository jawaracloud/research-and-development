# 40 — DNS Packet Parser with eBPF

> **Type:** Tutorial

## What you're building

Parse DNS query wire format in XDP. Log queried hostnames to ring buffer.
...
// TODO: implement the 40-dns-parser eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 40-dns-parser.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `xdp / socket_filter` — the kernel attach point |
