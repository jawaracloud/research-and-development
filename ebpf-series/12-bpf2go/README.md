# 12 — bpf2go: Compile eBPF C → Go Assets

> **Type:** Tutorial

## What you're building

Use bpf2go to compile a .bpf.c file into a Go file with typed maps, programs, and links.
...
// TODO: implement the 12-bpf2go eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 12-bpf2go.bpf.c
