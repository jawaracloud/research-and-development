# 85 — Network Latency Measurement

> **Type:** How-To

## What you're building

Measure TCP RTT from kernel: time between SYN and ACK in kprobe.
...
| eBPF hook | `kprobe/tcp_rcv_established` |
...
// TODO: implement the 85-network-latency eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 85-network-latency.bpf.c
...
go build -o 85-network-latency .
sudo ./85-network-latency
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/tcp_rcv_established` — the kernel attach point |
