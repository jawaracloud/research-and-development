# 87 — Go Runtime Tracing (goroutines, GC)

> **Type:** How-To

## What you're building

Trace Go runtime.newproc (goroutine create), gcStart, gcMarkDone with uprobes.
...
// TODO: implement the 87-go-runtime eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 87-go-runtime.bpf.c
