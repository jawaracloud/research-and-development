# 77 — Crypto Mining Detection via Syscall Patterns

> **Type:** Tutorial

## What you're building

Mining workloads show sched_setaffinity + high CPU + specific library calls.
...
// TODO: implement the 77-crypto-mining eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 77-crypto-mining.bpf.c
...
go build -o 77-crypto-mining .
sudo ./77-crypto-mining
```
...
| Concept | Description |
|---------|-------------|
| Hook | `tracepoint/syscalls` — the kernel attach point |
