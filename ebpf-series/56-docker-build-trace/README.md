# 56 — Docker Build Step Tracing

> **Type:** How-To

## What you're building

Trace each RUN step in a Dockerfile build — catch unexpected network calls.
...
// TODO: implement the 56-docker-build-trace eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 56-docker-build-trace.bpf.c
...
go build -o 56-docker-build-trace .
sudo ./56-docker-build-trace
```
