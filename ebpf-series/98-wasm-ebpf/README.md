# 98 — WASM + eBPF: Wasm-based eBPF Plugins

> **Type:** Explanation + How-To

## What you're building

Bumblebee / wasm-bpf: package eBPF programs in OCI images and run via Wasm host.
...
// TODO: implement the 98-wasm-ebpf eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 98-wasm-ebpf.bpf.c
