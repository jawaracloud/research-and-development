# 60 — Building a Docker Security Monitor

> **Type:** Tutorial

## What you're building

Combine exec, file, and network events to build a rule-based Docker security monitor.
...
// TODO: implement the 60-docker-security eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 60-docker-security.bpf.c
...
go build -o 60-docker-security .
sudo ./60-docker-security
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe + LSM` — the kernel attach point |
