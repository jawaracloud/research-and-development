# 18 — eBPF Program Lifecycle Management

> **Type:** How-To

## What you're building

Pin programs to /sys/fs/bpf, persist across process restarts, hot-reload patterns.
...
// TODO: implement the 18-lifecycle eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 18-lifecycle.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `pinning` — the kernel attach point |
