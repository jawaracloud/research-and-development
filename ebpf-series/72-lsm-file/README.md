# 72 — Blocking File Access with LSM-BPF

> **Type:** How-To

## What you're building

Return EPERM from LSM hook to block deletes of protected paths inside containers.
...
// TODO: implement the 72-lsm-file eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 72-lsm-file.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `lsm/path_unlink` — the kernel attach point |
