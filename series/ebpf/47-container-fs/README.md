# 47 — Container Filesystem Access Monitoring

> **Type:** How-To

## What you're building

Track VFS opens per cgroup. Alert on writes outside expected paths.
...
// TODO: implement the 47-container-fs eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 47-container-fs.bpf.c
...
go build -o 47-container-fs .
sudo ./47-container-fs
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/vfs_open` — the kernel attach point |
