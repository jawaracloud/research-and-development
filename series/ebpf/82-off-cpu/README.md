# 82 — Off-CPU / Scheduler Tracing

> **Type:** How-To

## What you're building

Measure time threads spend blocked. Identify lock contention and I/O waits.
...
| eBPF hook | `kprobe/finish_task_switch` |
...
// TODO: implement the 82-off-cpu eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 82-off-cpu.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/finish_task_switch` — the kernel attach point |
