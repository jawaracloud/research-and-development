# 38 — Socket Filters: Per-Socket Packet Inspection

> **Type:** How-To

## What you're building

SO_ATTACH_BPF: drop or pass packets per socket based on protocol criteria.
...
// TODO: implement the 38-socket-filter eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 38-socket-filter.bpf.c
...
go build -o 38-socket-filter .
sudo ./38-socket-filter
```
...
| Concept | Description |
|---------|-------------|
| Hook | `socket_filter` — the kernel attach point |
