# 86 — TCP Retransmit and Connection Tracing

> **Type:** How-To

## What you're building

Count TCP retransmits per connection. Alert on threshold breach.
...
| eBPF hook | `tracepoint/tcp/tcp_retransmit_skb` |
...
// TODO: implement the 86-tcp-retransmit eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 86-tcp-retransmit.bpf.c
...
go build -o 86-tcp-retransmit .
sudo ./86-tcp-retransmit
```
...
| Concept | Description |
|---------|-------------|
| Hook | `tracepoint/tcp/tcp_retransmit_skb` — the kernel attach point |
