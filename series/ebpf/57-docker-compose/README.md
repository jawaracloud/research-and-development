# 57 — Docker Compose Multi-Container Monitoring

> **Type:** Tutorial

## What you're building

Unified traffic and syscall dashboard across all services in a Compose stack.
...
// TODO: implement the 57-docker-compose eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 57-docker-compose.bpf.c
...
go build -o 57-docker-compose .
sudo ./57-docker-compose
```
...
| Concept | Description |
|---------|-------------|
| Hook | `tc + cgroup` — the kernel attach point |
