# 28 — Stack Traces and Symbol Resolution

> **Type:** How-To

## What you're building

BPF_MAP_TYPE_STACK_TRACE + addr2line for kernel stack symbolization.
...
| eBPF hook | `kprobe + bpf_get_stackid` |
...
// TODO: implement the 28-stack-traces eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 28-stack-traces.bpf.c
...
go build -o 28-stack-traces .
sudo ./28-stack-traces
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe + bpf_get_stackid` — the kernel attach point |
