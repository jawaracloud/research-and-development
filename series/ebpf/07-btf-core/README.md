# 07 — BPF Type Format (BTF) and CO-RE

> **Type:** Explanation

## What you're building

BTF provides rich type info. CO-RE + vmlinux.h let a single BPF binary run on multiple kernel versions.
...
// TODO: implement the 07-btf-core eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 07-btf-core.bpf.c
