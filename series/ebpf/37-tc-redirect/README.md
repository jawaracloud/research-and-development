# 37 — TC: Packet Modification and Redirect

> **Type:** How-To

## What you're building

Rewrite source/dest IP or port. bpf_redirect_neigh for hairpin load balancing.
...
// TODO: implement the 37-tc-redirect eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 37-tc-redirect.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `tc/cls_bpf` — the kernel attach point |
