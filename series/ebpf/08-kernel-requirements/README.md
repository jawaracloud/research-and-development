# 08 — Kernel Requirements and Compatibility

> **Type:** Reference

## What you're building

Feature matrix: which eBPF features require which minimum kernel version.
...
// TODO: implement the 08-kernel-requirements eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 08-kernel-requirements.bpf.c
...
go build -o 08-kernel-requirements .
sudo ./08-kernel-requirements
```
