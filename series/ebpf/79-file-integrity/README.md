# 79 — File Integrity Monitoring

> **Type:** How-To

## What you're building

Hash-on-write detection: log any write to monitored file paths.
...
// TODO: implement the 79-file-integrity eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 79-file-integrity.bpf.c
...
go build -o 79-file-integrity .
sudo ./79-file-integrity
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/vfs_write` — the kernel attach point |
