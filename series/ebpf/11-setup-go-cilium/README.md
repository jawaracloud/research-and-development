# 11 — Setting Up Go 1.26 + cilium/ebpf

> **Type:** Tutorial

## What you're building

Initialize a Go 1.26 module, add cilium/ebpf dependency, install bpf2go, verify the toolchain.
...
// TODO: implement the 11-setup-go-cilium eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 11-setup-go-cilium.bpf.c
...
go build -o 11-setup-go-cilium .
sudo ./11-setup-go-cilium
```
