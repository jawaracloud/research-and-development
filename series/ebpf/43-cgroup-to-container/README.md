# 43 — Mapping Cgroup IDs to Container Names

> **Type:** How-To

## What you're building

Read /sys/fs/cgroup/memory/<id>/docker/<hash> — resolve cgroup ID → container metadata.
...
// TODO: implement the 43-cgroup-to-container eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 43-cgroup-to-container.bpf.c
...
go build -o 43-cgroup-to-container .
sudo ./43-cgroup-to-container
```
