# 25 — Tracing Process Lifecycle: fork, exec, exit

> **Type:** How-To

## What you're building

Watch processes come and go. Correlate PID → container cgroup.
...
// TODO: implement the 25-process-lifecycle eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 25-process-lifecycle.bpf.c
...
go build -o 25-process-lifecycle .
sudo ./25-process-lifecycle
```
