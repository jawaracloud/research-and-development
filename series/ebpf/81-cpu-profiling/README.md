# 81 — CPU Profiling with Perf Events

> **Type:** How-To

## What you're building

Sample-based CPU profiling with PERF_TYPE_SOFTWARE. Symbolize in Go userspace.
...
// TODO: implement the 81-cpu-profiling eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 81-cpu-profiling.bpf.c
...
go build -o 81-cpu-profiling .
sudo ./81-cpu-profiling
```
...
| Concept | Description |
|---------|-------------|
| Hook | `perf_event` — the kernel attach point |
