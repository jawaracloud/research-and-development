# 65 — Kubernetes DNS (CoreDNS) Monitoring

> **Type:** How-To

## What you're building

Trace DNS queries resolved by CoreDNS. Measure latency per query type.
...
// TODO: implement the 65-coredns eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 65-coredns.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/udp_recvmsg` — the kernel attach point |
