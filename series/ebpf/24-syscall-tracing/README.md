# 24 — Tracing syscalls: open, read, write, exec

> **Type:** How-To

## What you're building

Build a syscall audit log: capture filename, flags, return value per process.
...
// TODO: implement the 24-syscall-tracing eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 24-syscall-tracing.bpf.c
...
go build -o 24-syscall-tracing .
sudo ./24-syscall-tracing
```
