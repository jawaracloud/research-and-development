# 27 — Tracing Go Applications with Uprobes

> **Type:** How-To

## What you're building

Go ABI0 convention, reading goroutine stack args, tracing net/http.(*Server).ServeHTTP.
...
// TODO: implement the 27-go-uprobes eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 27-go-uprobes.bpf.c
