# 91 — Testing eBPF Programs in CI (GitHub Actions)

> **Type:** How-To + Tutorial

## What you're building

GitHub Actions workflow with a privileged runner (ubuntu-latest nested VM) for eBPF tests.
...
// TODO: implement the 91-ci-testing eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 91-ci-testing.bpf.c
