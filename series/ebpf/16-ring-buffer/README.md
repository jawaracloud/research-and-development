# 16 — Ring Buffer: Streaming Events to Userspace

> **Type:** How-To

## What you're building

ebpf.RingBuffer reader in Go — callback-based, zero-copy event streaming.
...
// TODO: implement the 16-ring-buffer eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 16-ring-buffer.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe + ring_buf` — the kernel attach point |
