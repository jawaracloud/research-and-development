# 70 — Multi-Cluster Network Tracing

> **Type:** How-To

## What you're building

Trace tunnel (VXLAN/Geneve) encapsulated traffic between clusters with XDP.
...
// TODO: implement the 70-multi-cluster eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 70-multi-cluster.bpf.c
...
go build -o 70-multi-cluster .
sudo ./70-multi-cluster
```
...
| Concept | Description |
|---------|-------------|
| Hook | `xdp + tc` — the kernel attach point |
