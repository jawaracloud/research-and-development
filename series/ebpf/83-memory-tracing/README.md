# 83 — Memory Allocation Tracing

> **Type:** How-To

## What you're building

Trace kmalloc / kfree. Build a live kernel memory allocation heatmap.
...
// TODO: implement the 83-memory-tracing eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 83-memory-tracing.bpf.c
...
go build -o 83-memory-tracing .
sudo ./83-memory-tracing
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/__kmalloc` — the kernel attach point |
