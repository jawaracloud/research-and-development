# 50 — BPF Namespace and Resource Limits

> **Type:** Explanation

## What you're building

BPF_PROG_LOAD limits, rlimit RLIMIT_MEMLOCK, BPF namespace isolation in kernel 5.14+.
...
// TODO: implement the 50-bpf-namespace eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 50-bpf-namespace.bpf.c
...
go build -o 50-bpf-namespace .
sudo ./50-bpf-namespace
```
