# 06 — eBPF Helper Functions Reference

> **Type:** Reference

## What you're building

Reference for bpf_map_lookup_elem, bpf_probe_read_kernel, bpf_get_current_pid_tgid, and friends.
...
// TODO: implement the 06-helper-functions eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 06-helper-functions.bpf.c
...
go build -o 06-helper-functions .
sudo ./06-helper-functions
```
