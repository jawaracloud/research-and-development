# 05 — The eBPF Verifier: Safety Guarantees

> **Type:** Explanation

## What you're building

Understand how the verifier proves your program is safe before it runs in the kernel.
...
// TODO: implement the 05-verifier eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 05-verifier.bpf.c
