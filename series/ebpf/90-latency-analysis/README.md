# 90 — Full-Stack Latency Analysis

> **Type:** Tutorial

## What you're building

Correlate user request → kernel TCP → disk I/O latency for a single request ID.
...
// TODO: implement the 90-latency-analysis eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 90-latency-analysis.bpf.c
...
go build -o 90-latency-analysis .
sudo ./90-latency-analysis
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe + tc + uprobe` — the kernel attach point |
