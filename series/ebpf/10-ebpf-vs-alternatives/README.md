# 10 — eBPF vs iptables, tc, and Kernel Modules

> **Type:** Explanation

## What you're building

Compare eBPF with traditional Linux networking/security mechanisms: performance, safety, flexibility.
...
// TODO: implement the 10-ebpf-vs-alternatives eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 10-ebpf-vs-alternatives.bpf.c
...
go build -o 10-ebpf-vs-alternatives .
sudo ./10-ebpf-vs-alternatives
```
