# 33 — XDP Packet Parsing: Ethernet, IP, TCP/UDP

> **Type:** How-To

## What you're building

Walk xdp_md data/data_end pointers safely past Ethernet, IP, and transport headers.
...
// TODO: implement the 33-xdp-parsing eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 33-xdp-parsing.bpf.c
