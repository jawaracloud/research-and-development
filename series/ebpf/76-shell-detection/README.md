# 76 — Detecting Suspicious Shell in Containers

> **Type:** Tutorial

## What you're building

Alert when shell (bash/sh/zsh) spawns inside a container that should have none.
...
// TODO: implement the 76-shell-detection eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 76-shell-detection.bpf.c
...
go build -o 76-shell-detection .
sudo ./76-shell-detection
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/sys_execve` — the kernel attach point |
