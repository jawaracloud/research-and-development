# 92 — Test Frameworks for eBPF Go Programs

> **Type:** How-To + Reference

## What you're building

BPF_PROG_TEST_RUN from Go, table-driven tests for map logic, mock kernel structs.
...
// TODO: implement the 92-test-frameworks eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 92-test-frameworks.bpf.c
...
go build -o 92-test-frameworks .
sudo ./92-test-frameworks
```
...
| Concept | Description |
|---------|-------------|
| Hook | `test` — the kernel attach point |
