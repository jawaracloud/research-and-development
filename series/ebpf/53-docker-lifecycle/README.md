# 53 — Tracing Docker Container Start/Stop

> **Type:** How-To

## What you're building

uprobe on containerd binary: capture container create/stop task events.
...
// TODO: implement the 53-docker-lifecycle eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 53-docker-lifecycle.bpf.c
...
go build -o 53-docker-lifecycle .
sudo ./53-docker-lifecycle
```
...
| Concept | Description |
|---------|-------------|
| Hook | `uprobe/containerd` — the kernel attach point |
