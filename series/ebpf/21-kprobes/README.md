# 21 — Kprobes: Hooking Kernel Functions

> **Type:** How-To

## What you're building

Attach to any exported kernel function. Read arguments with bpf_probe_read_kernel_str.
...
// TODO: implement the 21-kprobes eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 21-kprobes.bpf.c
