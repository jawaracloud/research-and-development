# 95 — BTF Generation and vmlinux.h

> **Type:** How-To

## What you're building

bpftool btf dump file /sys/kernel/btf/vmlinux format c > vmlinux.h — one file, all types.
...
// TODO: implement the 95-btf-vmlinux eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 95-btf-vmlinux.bpf.c
