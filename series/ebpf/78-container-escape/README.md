# 78 — Container Escape Detection

> **Type:** Tutorial

## What you're building

Detect host namespace pivots, /proc/1/ns access, chroot from container.
...
// TODO: implement the 78-container-escape eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 78-container-escape.bpf.c
...
go build -o 78-container-escape .
sudo ./78-container-escape
```
...
| Concept | Description |
|---------|-------------|
| Hook | `kprobe/setns + lsm` — the kernel attach point |
