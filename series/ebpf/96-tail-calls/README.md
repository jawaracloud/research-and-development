# 96 — Tail Calls and Program Chaining

> **Type:** How-To

## What you're building

bpf_tail_call to jump between eBPF programs without returning, extending 4096-insn limit.
...
| eBPF hook | `BPF_MAP_TYPE_PROG_ARRAY` |
...
// TODO: implement the 96-tail-calls eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 96-tail-calls.bpf.c
...
| Concept | Description |
|---------|-------------|
| Hook | `BPF_MAP_TYPE_PROG_ARRAY` — the kernel attach point |
