# 03 — eBPF Program Types Overview

> **Type:** Reference

## What you're building

Reference card for all eBPF program types (kprobe, tracepoint, XDP, TC, LSM, etc.).
...
// TODO: implement the 03-program-types eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 03-program-types.bpf.c
...
go build -o 03-program-types .
sudo ./03-program-types
```
