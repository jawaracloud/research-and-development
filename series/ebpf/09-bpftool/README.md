# 09 — bpftool: Inspect, Load, and Debug eBPF

> **Type:** How-To

## What you're building

Use bpftool prog list, bpftool map dump, bpftool net show to inspect live eBPF programs.
...
// TODO: implement the 09-bpftool eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 09-bpftool.bpf.c
