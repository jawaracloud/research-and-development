# 51 — Docker Architecture and eBPF Hook Points

> **Type:** Explanation

## What you're building

containerd → runc → cgroup v2 → eBPF hooks. Where to attach for Docker events.
...
// TODO: implement the 51-docker-hooks eBPF program
...
```go
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang Bpf 51-docker-hooks.bpf.c
...
go build -o 51-docker-hooks .
sudo ./51-docker-hooks
```
