# 95 — HTML Reports and Allure Integration

> **Type:** How-To

## What you're testing

playwright show-report, allure-playwright reporter, GitHub Pages publish.
...
test.describe('95 — HTML Reports and Allure Integration', () => {
