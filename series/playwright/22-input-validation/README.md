# 22 — Input Validation: Required, Pattern, Min/Max

> **Type:** How-To

## What you're testing

HTML5 constraint validation, custom JS validation, error message visibility.
...
test.describe('22 — Input Validation: Required, Pattern, Min/Max', () => {
