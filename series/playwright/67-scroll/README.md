# 67 — Scroll Behavior: Scroll-to-top, Sticky Headers

> **Type:** How-To

## What you're testing

page.evaluate('window.scrollTo(0,500)'), sticky header toBe visible.
...
test.describe('67 — Scroll Behavior: Scroll-to-top, Sticky Headers', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3000/pages/interactive.html');
  });
