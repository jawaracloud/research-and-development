# 26 — Custom Dropdowns (Searchable, Multi-select)

> **Type:** How-To

## What you're testing

Click trigger, type to filter, select option from listbox, close on outside click.
...
test.describe('26 — Custom Dropdowns (Searchable, Multi-select)', () => {
