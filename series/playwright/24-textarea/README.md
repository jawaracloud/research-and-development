# 24 — Textarea: Multiline, Character Count

> **Type:** How-To

## What you're testing

fill() multiline text, char count updates, maxlength boundary test.
...
test.describe('24 — Textarea: Multiline, Character Count', () => {
