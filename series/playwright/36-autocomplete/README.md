# 36 — Autocomplete / Typeahead Inputs

> **Type:** How-To

## What you're testing

Type partial text, wait for dropdown, arrow-key navigate, Enter-select option.
...
test.describe('36 — Autocomplete / Typeahead Inputs', () => {
