# 69 — Countdown Timers and Progress Bars

> **Type:** How-To

## What you're testing

Progress bar width increases over time, aria-valuenow attribute assertion.
...
test.describe('69 — Countdown Timers and Progress Bars', () => {
