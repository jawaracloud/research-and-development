# 35 — File Upload: Single, Multiple, Drag-and-Drop

> **Type:** How-To

## What you're testing

setInputFiles(), multiple files, MIME type filtering, drop event simulation.
...
test.describe('35 — File Upload: Single, Multiple, Drag-and-Drop', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3000/pages/advanced-inputs.html');
  });
