# 49 — Accordion and Collapsible Panels

> **Type:** How-To

## What you're testing

Click header to expand: body visible, aria-expanded=true. Click again: collapses.
...
test.describe('49 — Accordion and Collapsible Panels', () => {
