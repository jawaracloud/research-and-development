# 09 — Debugging: Trace Viewer, Inspector, --headed

> **Type:** How-To + Tutorial

## What you're testing

PWDEBUG=1, Playwright Inspector, trace: 'on', npx playwright show-trace.
...
test.describe('09 — Debugging: Trace Viewer, Inspector, --headed', () => {
