# 77 — Responsive Testing: Viewports and Devices

> **Type:** How-To

## What you're testing

page.setViewportSize({width:375,height:812}), devices['iPhone 14'].
...
test.describe('77 — Responsive Testing: Viewports and Devices', () => {
