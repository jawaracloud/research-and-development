# 75 — Geolocation, Permissions, and Browser APIs

> **Type:** How-To

## What you're testing

context.grantPermissions(['geolocation']), setGeolocation({ lat, lng }).
...
test.describe('75 — Geolocation, Permissions, and Browser APIs', () => {
