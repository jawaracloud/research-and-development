# 38 — Rich Text Editors (contenteditable, WYSIWYG)

> **Type:** How-To

## What you're testing

click contenteditable, type text, Ctrl+B bold, innerHTML assertion.
...
test.describe('38 — Rich Text Editors (contenteditable, WYSIWYG)', () => {
