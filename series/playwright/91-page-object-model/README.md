# 91 — Page Object Model (POM) Design Pattern

> **Type:** Explanation + How-To

## What you're testing

LoginPage class with methods: fill(), submit(), assertError(). DRY tests.
...
test.describe('91 — Page Object Model (POM) Design Pattern', () => {
