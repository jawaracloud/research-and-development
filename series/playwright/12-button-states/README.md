# 12 — Button States: Disabled, Loading, Toggle

> **Type:** How-To

## What you're testing

Disabled attribute, aria-busy loading state, aria-pressed toggle.
...
test.describe('12 — Button States: Disabled, Loading, Toggle', () => {
