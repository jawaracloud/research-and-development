# 79 — Network Interception: Simulate Errors and Delays

> **Type:** How-To

## What you're testing

route.abort(), route.continue({delay:2000}), verify error state shown.
...
test.describe('79 — Network Interception: Simulate Errors and Delays', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3000/pages/api-mock.html');
  });
