# 86 — CRUD Operations: Create, Read, Update, Delete

> **Type:** Tutorial

## What you're testing

Add todo → visible, check done → strikethrough, delete → gone.
...
test.describe('86 — CRUD Operations: Create, Read, Update, Delete', () => {
