# 94 — Visual Regression Testing (screenshot diff)

> **Type:** How-To + Tutorial

## What you're testing

toMatchSnapshot(), update snapshots with --update-snapshots, pixel threshold.
...
test.describe('94 — Visual Regression Testing (screenshot diff)', () => {
