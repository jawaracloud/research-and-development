# 89 — Email Notification Verification (Mailhog)

> **Type:** How-To

## What you're testing

Submit form, GET Mailhog API /api/v2/messages, assert subject and recipient.
...
test.describe('89 — Email Notification Verification (Mailhog)', () => {
