# 90 — Cross-Browser Testing: Chrome, Firefox, WebKit

> **Type:** How-To

## What you're testing

projects config, run specific project: --project=firefox, browser version.
...
test.describe('90 — Cross-Browser Testing: Chrome, Firefox, WebKit', () => {
