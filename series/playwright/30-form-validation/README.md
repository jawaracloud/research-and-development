# 30 — Form Validation Feedback: Inline Errors, Toast

> **Type:** How-To

## What you're testing

Submit empty form, assert each error message visible, fix and resubmit.
...
test.describe('30 — Form Validation Feedback: Inline Errors, Toast', () => {
