# 13 — Icon Buttons and Accessibility Labels

> **Type:** How-To

## What you're testing

Buttons with only an icon — located by aria-label, not text.
...
test.describe('13 — Icon Buttons and Accessibility Labels', () => {
