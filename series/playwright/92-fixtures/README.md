# 92 — Fixtures, Custom Matchers, and Test Utils

> **Type:** How-To + Reference

## What you're testing

test.extend() to create authenticated page fixture. Custom expect.extend().
...
test.describe('92 — Fixtures, Custom Matchers, and Test Utils', () => {
