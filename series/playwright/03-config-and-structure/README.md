# 03 — Test Config and Project Structure

> **Type:** How-To + Reference

## What you're testing

playwright.config.ts settings: baseURL, retries, reporters, projects.
...
test.describe('03 — Test Config and Project Structure', () => {
