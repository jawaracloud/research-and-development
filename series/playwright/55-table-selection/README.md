# 55 — Table Row Selection and Bulk Actions

> **Type:** How-To

## What you're testing

Select-all checkbox selects all rows, individual select, bulk delete action.
...
test.describe('55 — Table Row Selection and Bulk Actions', () => {
