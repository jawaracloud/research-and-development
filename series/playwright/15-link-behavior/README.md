# 15 — Link Behavior: target=_blank, rel=noopener

> **Type:** How-To

## What you're testing

popup() event for new tabs, verifying rel attribute security attribute.
...
test.describe('15 — Link Behavior: target=_blank, rel=noopener', () => {
