# 93 — Test Data Management: Factories and Seeding

> **Type:** How-To

## What you're testing

Factory functions for test users, JSON fixtures, beforeAll DB seed.
...
test.describe('93 — Test Data Management: Factories and Seeding', () => {
