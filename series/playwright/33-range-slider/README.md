# 33 — Range Sliders: Single and Dual-thumb

> **Type:** How-To

## What you're testing

fill() for range input, dragTo() for custom sliders, value assertion.
...
test.describe('33 — Range Sliders: Single and Dual-thumb', () => {
