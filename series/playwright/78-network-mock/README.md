# 78 — Network Interception: Mock API Responses

> **Type:** How-To + Tutorial

## What you're testing

page.route('/api/users', route => route.fulfill({body: JSON.stringify([])})).
...
test.describe('78 — Network Interception: Mock API Responses', () => {
