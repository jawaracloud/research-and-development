# 59 — Charts and Graphs (Canvas-based)

> **Type:** How-To

## What you're testing

Canvas element present, screenshot comparison, tooltip on hover via evaluate().
...
test.describe('59 — Charts and Graphs (Canvas-based)', () => {
