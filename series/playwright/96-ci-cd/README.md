# 96 — CI/CD: GitHub Actions for Playwright

> **Type:** How-To + Tutorial

## What you're testing

Workflow YAML: install, cache, browsers, run tests, upload artifact report.
...
test.describe('96 — CI/CD: GitHub Actions for Playwright', () => {
