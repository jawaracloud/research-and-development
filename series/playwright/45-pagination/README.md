# 45 — Pagination: Page Numbers, Infinite Scroll

> **Type:** How-To

## What you're testing

Click page 3, prev/next disabled at boundaries, current page highlighted.
...
test.describe('45 — Pagination: Page Numbers, Infinite Scroll', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3000/pages/navigation.html');
  });
