# 60 — Empty States, Skeleton Loaders, Spinners

> **Type:** How-To

## What you're testing

Trigger empty state assertion, skeleton animation present, spinner aria-busy.
...
test.describe('60 — Empty States, Skeleton Loaders, Spinners', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3000/pages/data-display.html');
  });
