# 47 — Confirmation Dialogs (browser alert/confirm)

> **Type:** How-To

## What you're testing

page.on('dialog'), dialog.accept() / .dismiss(), dialog.message() assertion.
...
test.describe('47 — Confirmation Dialogs (browser alert/confirm)', () => {
