# 16 — Static Text and Headings Verification

> **Type:** How-To

## What you're testing

toHaveText, toContainText, heading level assertions with getByRole('heading').
...
test.describe('16 — Static Text and Headings Verification', () => {
