# 23 — Password Fields: Show/Hide Toggle, Strength Meter

> **Type:** How-To

## What you're testing

input[type=password] → type=text toggle, strength bar width assertion.
...
test.describe('23 — Password Fields: Show/Hide Toggle, Strength Meter', () => {
