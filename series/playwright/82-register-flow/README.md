# 82 — Registration Flow with Validation

> **Type:** Tutorial

## What you're testing

Fill all fields correctly → success. Each field invalid alone → specific error.
...
test.describe('82 — Registration Flow with Validation', () => {
