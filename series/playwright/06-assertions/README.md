# 06 — Assertions (expect) — Positive & Negative

> **Type:** How-To + Reference

## What you're testing

toBeVisible, toHaveText, toBeEnabled, toBeDisabled, toHaveValue, toHaveURL, toHaveCount.
...
test.describe('06 — Assertions (expect) — Positive & Negative', () => {
