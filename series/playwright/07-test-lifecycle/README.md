# 07 — Test Lifecycle: beforeAll, beforeEach, afterEach

> **Type:** How-To

## What you're testing

Setup and teardown hooks. Sharing state with test.describe scope.
...
test.describe('07 — Test Lifecycle: beforeAll, beforeEach, afterEach', () => {
