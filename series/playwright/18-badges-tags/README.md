# 18 — Badges, Tags, and Status Indicators

> **Type:** How-To

## What you're testing

Status badge colors/text, tag presence, aria-live region announcements.
...
test.describe('18 — Badges, Tags, and Status Indicators', () => {
