# 80 — LocalStorage, SessionStorage, Cookies

> **Type:** How-To

## What you're testing

evaluate() to set/get localStorage, context.addCookies(), storageState.
...
test.describe('80 — LocalStorage, SessionStorage, Cookies', () => {
