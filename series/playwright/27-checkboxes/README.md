# 27 — Checkboxes: Single, Group, Indeterminate

> **Type:** How-To

## What you're testing

check(), uncheck(), isChecked(), indeterminate via JS, select-all pattern.
...
test.describe('27 — Checkboxes: Single, Group, Indeterminate', () => {
