# 81 — Login Flow: Happy Path + Negative Cases

> **Type:** Tutorial

## What you're testing

Login with valid credentials → protected area visible. Invalid → error shown.
...
test.describe('81 — Login Flow: Happy Path + Negative Cases', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3000/pages/auth.html');
  });
