# 41 — Navigation Bar and Hamburger Menu

> **Type:** How-To

## What you're testing

Desktop nav visible, mobile: hamburger click opens nav, close on outside click.
...
test.describe('41 — Navigation Bar and Hamburger Menu', () => {
