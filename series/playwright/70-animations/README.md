# 70 — Animations, Transitions, CSS Motion

> **Type:** How-To

## What you're testing

waitForSelector with state:'visible' after animation, screenshot diff.
...
test.describe('70 — Animations, Transitions, CSS Motion', () => {
