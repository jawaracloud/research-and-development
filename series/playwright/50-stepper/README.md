# 50 — Stepper / Wizard Multi-Step Forms

> **Type:** How-To + Tutorial

## What you're testing

Fill step 1, click Next, verify step 2 shown. Back preserves step-1 data.
...
test.describe('50 — Stepper / Wizard Multi-Step Forms', () => {
