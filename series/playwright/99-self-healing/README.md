# 99 — AI Agent: Self-Healing Selectors and Auto-fix

> **Type:** How-To + Explanation

## What you're testing

Strategies to make tests resilient: data-testid as contract, AI-assisted selector repair.
...
test.describe('99 — AI Agent: Self-Healing Selectors and Auto-fix', () => {
